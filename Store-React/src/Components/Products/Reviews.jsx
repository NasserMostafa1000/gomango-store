    ...
    <div className="mt-6">
          ...
          {items.map((r) => (
            <li key={r.id} className="p-4 md:p-6 hover:bg-gray-50/50 transition-colors">
              ...
              <div className="flex items-start gap-3 mb-3">
                ...
                <div className="flex-shrink-0 w-10 h-10 rounded-full bg-gradient-to-br from-[#0a2540] to-[#13345d] flex items-center justify-center text-white font-bold text-sm shadow-md">
                ...
                <div className="flex-1">
                  ...
                  {/* نص التعليق */}
                  <div className="bg-gray-50 rounded-lg p-3 border-r-4 border-[#0a2540] mb-3">
                  ...
                  <div className="mb-3">
                    <button
                      ...
                      className="inline-flex items-center gap-2 text-sm font-semibold text-white bg-[#0a2540] hover:bg-[#ff7a00] px-3 py-1.5 rounded-lg shadow-sm transition-all"
                    >
      ...
      {totalPages > 1 && (
        <div className="flex items-center justify-center gap-2 mt-4">
          <button
            className="px-4 py-2 rounded-xl bg-[#0a2540] hover:bg-[#13345d] text-white font-semibold disabled:opacity-50 disabled:cursor-not-allowed transition-all shadow-md"
