          ...
          <div className="p-4 border-t space-y-3" style={{ borderColor: 'rgba(15, 23, 42, 0.08)' }}>
            ...
            {isLoggedIn && (
              <button
                ...
                className={`w-full flex items-center justify-center gap-2 px-4 py-3 rounded-lg text-white font-medium hover:bg-red-700 transition-colors ${isRTL ? 'flex-row-reverse' : ''}`}
              ...
              >
                ...
                <span style={{ textAlign: isRTL ? 'right' : 'left' }}>{t('logout', "تسجيل خروج")}</span>
              </button>
            )}
          </div>
        </div>
