...
export default function PhoneModal({
  ...
  return (
    ...
    >
      <div className="bg-blue-800 rounded-2xl shadow-2xl border-2 border-orange-500 p-6 w-full max-w-md transform transition-all duration-300 scale-100 hover:scale-105">
        ...
        <input
          ...
          className="w-full px-4 py-3 bg-blue-700 border-2 border-orange-500 rounded-lg text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-orange-500 focus:border-orange-500 transition duration-200 mb-6 text-right"
          dir="rtl"
        />
